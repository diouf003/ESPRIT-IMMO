        ...
        <div class="card ">
            <div class="card-header  d-flex align-items-center" style="background-color:blue; color:white">
                ...
                <div class="card-tools d-flex align-items-center ">
                    <a href="#" class="btn btn-link text-white mr-4 d-block" wire:click="showAddArticleModal"><i
                            class="fas fa-user-plus"></i>Ajouter d'un
                        type de logement</a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a title="Tarifs {{$article->nom}}"
                                        href="{{route('admin.gestarticles.articles.tarifs', ['articleId'=> $article->id]) }}"
                                        class="btn btn-link"><i class="fas fa-money-check"></i></a>

                                    <button class="btn btn-link" wire:click="editArticle({{$article->id}})"><i
                                            class="far fa-edit"></i></button>

                                    <button class="btn btn-link" wire:click="confirmDelete({{$article->id}})"><i
