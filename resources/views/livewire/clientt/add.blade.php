        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="ajouterArticle">
                    ...
                    <div class="d-flex">
                        <div class="my-4 bg-gray-light p-3 flex-grow-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="addArticle.noSerie" class="form-control" placeholder="NoSerie">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="flex-grow-1 p-4">
                            ...
                            <div style="border : 1px solid #d0d1d3; border-radius: 20px; height: 400px; width: 700px; overflow:hidden;">
                ...
                <div class="modal-footer bg-dark">
                    <button type="submit" style="color: white; background:black;">Envoyer</button>
                    <button type="button" style="color: white; background:black;" wire:click="closeModal">Fermer</button>
