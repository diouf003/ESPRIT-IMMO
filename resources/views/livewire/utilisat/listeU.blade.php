            ...
            <div class="card-header bg-dark d-flex align-items-center">
                ...
                <div class="card-tools d-flex align-items-center">
                    <a href="#" class="btn btn-link text-white mr-4 d-block" wire:click.prevent="goToAddUser()"><i
                            class="fas fa-user-plus"></i>Demande Logement</a>
                ...
                <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$client->prenom}} {{$client->name}} </td>
                            <td>{{$client->AllRoleNames }}</td>
                            <td class="text-center"><span
                                    class="tag tag-success">{{\Carbon\Carbon::parse($client['created_at'])->diffForHumans() }}</span>
                            </td>
