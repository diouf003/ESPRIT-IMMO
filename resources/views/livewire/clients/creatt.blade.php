            ...
            <form role="form" wire:submit.prevent="addClient()">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('addClient.dateNaissance') @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('addClient.lieuNaissance') @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('addClient.nationalite') @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('addClient.email') @enderror"
                    ...
                    <div class="form-group">
                        <label>Pays</label>
                        <input type="text" class="form-control @error('addClient.pays') @enderror"
                    ...
                    <div class="form-group">
                        <label>Ville</label>
                        <input type="text" class="form-control @error('addClient.ville') @enderror"
                    ...
                    <div class="form-group">
                        <label>Statut</label>
                        <select class="form-control @error('addClient.statut') is-invalid @enderror"
                            wire:model="addClient.statut">
                            <option value="">----------</option>
                    ...
                    <div class="form-group">
                        <label>Choix</label>
                        <select class="form-control @error('addClient.choixDuLogement') is-invalid @enderror"
                            wire:model="addClient.choixDuLogement">
                            <option value="">----------</option>
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            ...
                            <input type="numeric" class="form-control   @error('addClient.telephone1') @enderror"
                    ...
                    <div class="from-group">
                        ...
                        <select class="form-control  @error('addClient.pieceIdentite') @enderror"
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control @error('addClient.noPieceIdentite') @enderror"
                ...
                <div class="card-footer">
                    ...
                    <button type="button" wire:click="goToListClient()" class="btn "
                        style="background: blue; color:white">Retour</button>
                </div>
            </form>
        </div>
