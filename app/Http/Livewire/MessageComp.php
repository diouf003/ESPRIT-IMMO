...
class MessageComp extends Component
{
    ...
    public function addReponse()
    {
        ...
        Reponse::create($validationAttributes["addReponse"]);

        $this->addReponse = [];

        $this->dispatchBrowserEvent("showSuccessMessage", ["message" => "Réponse envoyé au locataire avec succès!"]);
    }
